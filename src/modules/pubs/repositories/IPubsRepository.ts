...
interface IPubsRepository {
  ...
  findAll(): Promise<Pub[]>;
  update(id: string, user_id: string, data: IUpdatePubDTO): Promise<UpdateResult>;
  updateLocation(id: string, user_id: string, data: IUpdatePubLocationDTO): Promise<UpdateResult>;
